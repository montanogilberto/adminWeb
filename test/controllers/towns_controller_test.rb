...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { asentamiento: @town.asentamiento, state_id: @town.state_id, township_id: @town.township_id } }
    end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { asentamiento: @town.asentamiento, state_id: @town.state_id, township_id: @town.township_id } }
