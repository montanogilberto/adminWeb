class ExpedientsController < ApplicationController
  ...
  private
    ...
    def expedient_params
      params.require(:expedient).permit(:noExpedient, :year, :active, :actor, :defendant, :fee, :payment, :saldo, :customer_id, :court_id, :district_id, :act_id, :matter_id, :judgment_id)
    end
end
